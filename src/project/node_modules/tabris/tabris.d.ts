// Type definitions for Tabris.js 3.9.0
...
export interface ActionFactory extends Factory<ActionConstructor, widgets.Action>, ActionConstructor {}
...
export interface ActivityIndicatorFactory extends Factory<ActivityIndicatorConstructor, widgets.ActivityIndicator>, ActivityIndicatorConstructor {}
...
export interface ButtonFactory extends Factory<ButtonConstructor, widgets.Button>, ButtonConstructor {}
...
export interface CameraViewFactory extends Factory<CameraViewConstructor, widgets.CameraView>, CameraViewConstructor {}
...
export interface CanvasFactory extends Factory<CanvasConstructor, widgets.Canvas>, CanvasConstructor {}
...
export interface CheckBoxFactory extends Factory<CheckBoxConstructor, widgets.CheckBox>, CheckBoxConstructor {}
...
export interface CollectionViewFactory extends Factory<CollectionViewConstructor, widgets.CollectionView>, CollectionViewConstructor {}
...
export namespace widgets {
   ...
   */
  export class Composite<ChildType extends AnyWidget = Widget> extends Widget {
...
export type Composite<ChildType extends AnyWidget = Widget> = widgets.Composite<ChildType>;
export type CompositeConstructor = typeof widgets.Composite;
export interface CompositeFactory extends Factory<CompositeConstructor, widgets.Composite>, CompositeConstructor {}
 ...
 */
export class ContentView<ChildType extends AnyWidget = Widget> extends Composite<ChildType> {
...
export interface ImageViewFactory extends Factory<ImageViewConstructor, widgets.ImageView>, ImageViewConstructor {}
...
export interface NavigationViewFactory extends Factory<NavigationViewConstructor, widgets.NavigationView>, NavigationViewConstructor {}
...
export interface PageFactory extends Factory<PageConstructor, widgets.Page>, PageConstructor {}
...
export interface PdfViewFactory extends Factory<PdfViewConstructor, widgets.PdfView>, PdfViewConstructor {}
...
export interface PickerFactory extends Factory<PickerConstructor, widgets.Picker>, PickerConstructor {}
...
export interface ProgressBarFactory extends Factory<ProgressBarConstructor, widgets.ProgressBar>, ProgressBarConstructor {}
...
export interface RadioButtonFactory extends Factory<RadioButtonConstructor, widgets.RadioButton>, RadioButtonConstructor {}
...
export interface RefreshCompositeFactory extends Factory<RefreshCompositeConstructor, widgets.RefreshComposite>, RefreshCompositeConstructor {}
...
export interface RowFactory extends Factory<RowConstructor, widgets.Row>, RowConstructor {}
...
export interface ScrollViewFactory extends Factory<ScrollViewConstructor, widgets.ScrollView>, ScrollViewConstructor {}
...
export interface SearchActionFactory extends Factory<SearchActionConstructor, widgets.SearchAction>, SearchActionConstructor {}
...
export interface SliderFactory extends Factory<SliderConstructor, widgets.Slider>, SliderConstructor {}
...
export interface StackFactory extends Factory<StackConstructor, widgets.Stack>, StackConstructor {}
...
export interface SwitchFactory extends Factory<SwitchConstructor, widgets.Switch>, SwitchConstructor {}
...
export interface TabFactory extends Factory<TabConstructor, widgets.Tab>, TabConstructor {}
...
export interface TabFolderFactory extends Factory<TabFolderConstructor, widgets.TabFolder>, TabFolderConstructor {}
...
export interface TextInputFactory extends Factory<TextInputConstructor, widgets.TextInput>, TextInputConstructor {}
...
export interface TextViewFactory extends Factory<TextViewConstructor, widgets.TextView>, TextViewConstructor {}
...
export interface ToggleButtonFactory extends Factory<ToggleButtonConstructor, widgets.ToggleButton>, ToggleButtonConstructor {}
...
export interface VideoFactory extends Factory<VideoConstructor, widgets.Video>, VideoConstructor {}
...
export interface WebViewFactory extends Factory<WebViewConstructor, widgets.WebView>, WebViewConstructor {}
...
export class Widget<TData extends object = any> extends NativeObject {
   ...
   * @param selector A selector expression or a predicate function to filter the results.
   */
  parent<Result extends Composite = Composite>(selector: ParentSelector<Composite, Result>): Result;
 ...
 */
export class WidgetCollection<WidgetType extends AnyWidget = Widget> {
